...
describe('OnionooService', () => {
    ...
    it('should extract ator key when spammed but not reusing keyword', () => {
        expect(
            service.extractAtorKey('@ator@ator:	 	 0xf72a247Dc4546b0291dbbf57648D45a752537802  kpaojak9oo3 @ator')
        ).toEqual('0xf72a247Dc4546b0291dbbf57648D45a752537802')
    })

    it('should extract ator key from first keyword when spammed', () => {
        expect(
            service.extractAtorKey('@ator@ator:	 	 0xf72a247Dc4546b0291dbbf57648D45a752537802  kpaojak9oo3 @ator:0x0000000000000000000000000000000000000000')
        ).toEqual('0xf72a247Dc4546b0291dbbf57648D45a752537802')
    })

    it('should fail extracting ator key when invalid keyword', () => {
        expect(
            service.extractAtorKey('@ator@ator; 0xf72a247Dc4546b0291dbbf57648D45a752537802  kpaojak9oo3')
        ).toEqual('')
    })

    it('should fail extracting ator key when the line is cut', () => {
        expect(
            service.extractAtorKey('@ator@ator: 0xf72a247Dc4546b0291dbbf57648D45a75253780')
        ).toEqual('')
    })

    it('should fail extracting ator key when invalid checksum in key', () => {
        expect(
            service.extractAtorKey('@ator: 0x8Ba1f109551bD432803012645Ac136ddd64DBa72')
        ).toEqual('')
    })

    it('should fail extracting ator key when invalid characters in key', () => {
        expect(
            service.extractAtorKey('@ator: 0xZY*!"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF')
        ).toEqual('')
    })
})
